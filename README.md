...
|--------|-----------|----------------|---------|
| 100 | 0.000040 с | 0.000007 с | **0.000002 с** |
| 1000 | 0.000551 с | 0.000598 с | **0.000028 с** |
| 5000 | 0.003369 с | 0.049398 с | **0.000278 с** |
| 10000 | 0.007295 с | 0.202121 с | **0.000604 с** |

**Спостереження:**

- Timsort **у 12 разів швидший** за Merge Sort (0.000604 с проти 0.007295 с)
- Insertion Sort сповільнюється: у **28 разів повільніший** за Merge Sort на 10000 елементах
...
| Розмір | Merge Sort | Insertion Sort | Timsort |
|--------|-----------|----------------|---------|
| 100 | 0.000034 с | **0.000002 с** | **0.000000 с** |
| 1000 | 0.000446 с | 0.000029 с | **0.000003 с** |
| 5000 | 0.002595 с | 0.000141 с | **0.000014 с** |
| 10000 | 0.005419 с | 0.000290 с | **0.000027 с** |

**Спостереження:**

- Timsort досягає O(n) на відсортованих даних - **у 200 разів швидший** за Merge Sort!
- Insertion Sort також ефективний (O(n)) - **у 19 разів швидший** за Merge Sort
...
| Розмір | Merge Sort | Insertion Sort | Timsort |
|--------|-----------|----------------|---------|
| 100 | 0.000035 с | 0.000014 с | **0.000000 с** |
| 1000 | 0.000458 с | 0.001132 с | **0.000003 с** |
| 5000 | 0.002657 с | 0.097522 с | **0.000018 с** |
| 10000 | 0.005592 с | 0.392935 с | **0.000030 с** |

**Спостереження:**

- Insertion Sort показує найгіршу продуктивність O(n²): **у 70 разів повільніший** за Merge Sort!
- Timsort залишається найшвидшим - **у 186 разів швидший** за Merge Sort
...
| Розмір | Merge Sort | Insertion Sort | Timsort |
|--------|-----------|----------------|---------|
| 100 | 0.000036 с | 0.000003 с | **0.000003 с** |
| 1000 | 0.000512 с | 0.000165 с | **0.000028 с** |
| 5000 | 0.003038 с | 0.010972 с | **0.000145 с** |
| 10000 | 0.006404 с | 0.046313 с | **0.000303 с** |

**Спостереження:**

- Timsort найефективніший завдяки виявленню природного порядку - **у 21 раз швидший** за Merge Sort
- Insertion Sort показує прийнятні результати завдяки частковій впорядкованості - **у 7 разів швидший** за Merge Sort
...
| Розмір | Merge Sort | Insertion Sort | Timsort |
|--------|-----------|----------------|---------|
| 50000 | 0.041439 с | 5.172530 с | **0.003621 с** |
| 100000 | 0.088025 с | 21.049034 с | **0.007743 с** |

**Спостереження:**

- Timsort **у 11 разів швидший** за Merge Sort
- Insertion Sort **у 239 разів повільніший** за Merge Sort і **у 2719 разів повільніший** за Timsort!
- На 100000 елементів: Timsort - 7.7 мс, Merge Sort - 88 мс, Insertion Sort - **21 секунда**!
...
- Час збільшився: 0.000598 с → 0.202121 с
- Коефіцієнт: **~338 разів**

При збільшенні у 100 разів (1000 → 100000):

- Час збільшився: 0.000598 с → 21.049034 с
- Коефіцієнт: **~35200 разів**
...
- Час збільшився: 0.007295 с → 0.088025 с
- Коефіцієнт: **~12.1 рази**
- Теоретично: 10 × log₂(10) ≈ 10 × 3.32 ≈ **13.3** ✓

При збільшенні у 2 рази (50000 → 100000):

- Час збільшився: 0.041439 с → 0.088025 с
...
- Час: 0.000604 с → 0.007743 с
- Коефіцієнт: **~12.8 рази**
- Поведінка схожа на Merge Sort, але з **набагато кращими константами** (у 11 разів швидший!)
...
1. **Insertion Sort:**
   ...
   - ✅ НАЙКРАЩИЙ на вже відсортованих даних: O(n) - у 19 разів швидший за Merge Sort
   - ⚠️ Прийнятний на майже відсортованих даних малого розміру
   - ❌ Катастрофічно повільний на великих масивах: 21 секунда проти 0.088 с (Merge Sort) на 100000 елементів
...
3. **Timsort:**
   ...
   - ✅ На відсортованих даних: у 200 разів швидший за Merge Sort
   - ✅ На зворотно відсортованих: у 186 разів швидший за Merge Sort
